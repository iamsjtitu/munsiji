...
const light = {
  ...
  onSurface: "#18181B", // text and icons on the canvas
  surfaceSecondary: "#FFFFFF", // cards, sheets, list rows
  onSurfaceSecondary: "#18181B", // text and icons on cards, sheets, rows
  surfaceTertiary: "#F4F4F5", // input backgrounds, chips, deepest nesting
  ...
  backdrop: "rgba(24, 24, 27, 0.45)", // modal / sheet scrim

  // ---------------------------------------------------------------------------
  // Brand: the identity color and the fills built from it.
  // Neutral by default; replace with the design guidelines values.
  // ---------------------------------------------------------------------------
  brand: "#047857", // base hue, anchor only; Primary, Secondary, Tertiary are weights of it
  onBrand: "#FFFFFF", // text and icons placed directly on brand
  brandPrimary: "#047857", // primary CTA, active tab indicator, selected states
  onBrandPrimary: "#FFFFFF", // text and icons on brandPrimary
  brandSecondary: "#D1FAE5", // secondary CTA, less prominent accents
  onBrandSecondary: "#065F46", // text and icons on brandSecondary
  brandTertiary: "#ECFDF5", // chips, tags, badges, subtle brand moments
  onBrandTertiary: "#065F46", // text and icons on brandTertiary
...
// Font families loaded in app/_layout.tsx (expo-font).
export const fonts = {
